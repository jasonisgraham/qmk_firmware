...
#define bootz_microphone _______,_______,_______,_______,_______,_______,_______,_______,_______, TD(DANCE_MICROPHONE),_______,_______, \
...
#define LAYOUT_wrapper(...) LAYOUT_ortho_4x12(__VA_ARGS__)
                                                              ...
                                                              [_BASE] = LAYOUT_wrapper(bootz_microphone),
};
