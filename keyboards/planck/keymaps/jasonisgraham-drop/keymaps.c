const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
   ...
   hyper, _______, _______, KC_LALT, RAISE,  super,  _______, my_space,           LOWER,           right_of_lower,   _______,  _______
  ),
  ...
  [_LOWER] = LAYOUT_planck_grid(
                                ...
                                _______,   KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_APPLICATION, _______, my_lower_n, my_lower_m, my_lower_comma,   TD(DANCE_30),   KC_DELETE,
  ...
  [_MOUSE] = LAYOUT_planck_grid(
                                ...
                                SHIFTLOCK_LAYER_ACTIVATE, _______, _______, _______, _______, _______, _______, _______, KC_MS_BTN3,     TD(DANCE_35),   TD(DANCE_36),   _______,
  ...
  [_WINDOWS] = LAYOUT_planck_grid(
                                  TO(_BASE), TD(DANCE_38),   TD(DANCE_39),   LGUI(KC_E),     TD(DANCE_40),   LGUI(KC_T),   _______,  TD(DANCE_41),        LGUI(KC_8),     LGUI(KC_9),     LGUI(KC_0),     LGUI(KC_MINUS),
                                   ...
                                   _______, _______, _______,         _______,        _______,      ALT_TAB , _______,         _______,  _______,   _______,   RGUI(KC_ESCAPE),_______
  ),
  ...
  [_MACROS] = LAYOUT_planck_grid(
   ...
   _______, emacs_a, CD_CSV, EMACS_YAS_DOC,     emacs_f,     EMACS_INSERT_GET_FEED, _______, _______, _______, EMACS_YAS_KEYS_DESCRUCTURE, EMACS_YAS_TL,     _______,
   _______, _______, _______, EMACS_YAS_C,     _______, _______, _______, _______, emacs_m,     _______, _______, TERM_CD_UP_DIR,
