...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // 6
    [_WINDOWS] = LAYOUT_planck_grid(TO(_BASE), WINDOWS_Q, TD(DANCE_39), LGUI(KC_E), TD(DANCE_40), LGUI(KC_T), LGUI(KC_MINUS), LGUI(KC_Y), LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), LGUI(KC_ESCAPE), LGUI(KC_A), select_slack, show_desktop, LGUI(KC_F), TD(DANCE_42), _______, LGUI(KC_H), TD(DANCE_43), TD(DANCE_44), TD(DANCE_45), _______, TO(_BASE), LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), _______, _______, TD(DANCE_46), LGUI(KC_M), _______, RSFT(LGUI(KC_K)), RCTL(LGUI(KC_Q)), _______, _______, _______, LALT(KC_6), _______, ALT_TAB, _______, LALT(KC_8), _______, OSL(_ADHOC_SET_HOTKEY), _______, _______),
    ...
    // 9
    [_WINMOVE] = LAYOUT_planck_grid(TO(_BASE), _______, _______, _______, _______, _______, _______, LGUI(RSFT(KC_Y)), _______, _______, LGUI(RSFT(KC_O)), _______, _______, _______, _______, LALT(LGUI(LCTL(KC_D))), _______, _______, _______, TD(DANCE_58), LGUI(RSFT(KC_J)), TD(DANCE_59), TD(DANCE_60), _______, _______, _______, _______, KC_F11, _______, _______, _______, LGUI(RSFT(KC_N)), TD(DANCE_47), _______, LGUI(RSFT(KC_DOT)), _______, _______, _______, _______, _______, TO(0), _______, KC_NO, TD(DANCE_48), TD(DANCE_49), TD(DANCE_50), _______, _______),
    ...
    // 12
    [_EDITING] = LAYOUT_planck_grid(TO(_BASE), _______, EMACS_OTHER_WINDOW, _______, EMACS_BUFFER_REVERT, _______, _______, EMACS_COPY_FILE_PATH, LCTL(KC_7), _______, EMACS_OTHER_WINDOW, _______, _______, _______, _______, _______, LALT(KC_ENTER), _______, RCTL(KC_QUOTE), LALT(RSFT(KC_H)), LALT(RSFT(KC_J)), LALT(RSFT(KC_K)), LALT(RSFT(KC_L)), RCTL(KC_SCOLON), _______, _______, _______, EMACS_WINDOW_CLOSE, _______, _______, _______, LALT(RSFT(KC_N)), EMACS_ACE_WINDOW_SWAP, _______, _______, TERM_CD_UP_DIR, _______, _______, _______, _______, OSL(18), _______, _______, KC_NO, LALT(KC_ENTER), _______, _______, _______
    ...
    [_ADHOC_SET_HOTKEY] = LAYOUT_planck_grid(TO(_BASE), LCTL(LALT(LGUI(KC_Y))), LCTL(LALT(LGUI(KC_W))), _______, LCTL(LALT(LGUI(KC_R))), _______, _______, LCTL(LALT(LGUI(KC_Y))), _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(LALT(LGUI(KC_G))), _______, _______, LCTL(LALT(LGUI(KC_J))), LCTL(LALT(LGUI(KC_K))), LCTL(LALT(LGUI(KC_L))), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(LALT(LGUI(KC_N))), _______, _______, _______, _______),
