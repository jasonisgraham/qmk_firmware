const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
    TD(DANCE_26),   KC_F1,          KC_F2,          KC_F3,          my_lower_r,          KC_PSCREEN,     KC_HOME,        KC_PGUP,        my_lower_i,      my_lower_o,         _______, TD(DANCE_27),
    _______, my_lower_a,          KC_F6,          KC_F7,          KC_F8,          my_lower_g,  KC_LEFT,       my_lower_j,        my_lower_k,          my_lower_l,       KC_LCBR,        KC_RCBR,
    ...
    _______, KC_NO, KC_LGUI,        KC_LALT,        MO(4),          OSL(_WINDOWS),          KC_NO,          _______, KC_NO,          KC_NO,          _______, _______
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    _______, DYN_REC_START2, DYN_MACRO_PLAY2,DYN_REC_STOP,   KC_NO,          FISH_ACCEPT_SEND,     my_raise_n,           my_raise_m,           my_raise_comma,         my_raise_period,           KC_QUES,      _______,
  ...
  [_SYSTEM] = LAYOUT_planck_grid(
    ...
    RGB_MODE_SNAKE, _______, _______, _______, _______, RGB_HUD,        RGB_HUI,        RGB_VAD,        RGB_VAI,        _______, KC_MEDIA_STOP,  _______,
    BL_BRTG, BL_STEP, _______, _______, _______, LED_LEVEL,      _______, RGB_MOD,        TOGGLE_LAYER_COLOR,KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,
    _______, TO(_BASE), _______, _______, _______, _______, KC_NO,          KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE
  ),
  ...
  [_WINDOWS] = LAYOUT_planck_grid(
   ...
   _______, _______, TO(14),         TT(12),         TT(9),          LGUI(KC_SPACE), KC_NO,          TD(DANCE_48),   TD(DANCE_49),   TD(DANCE_50),   RGUI(KC_ESCAPE),RCTL(RGUI(KC_Q))
  ),
  ...
  [_MACROS] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, EMACS_YAS_C,     _______, _______, _______, emacs_m,     _______, _______, _______, _______,
  ...
  [_EDITING] = LAYOUT_planck_grid(
                                  EMACS_OTHER_WINDOW, TO(_BASE), EMACS_OTHER_WINDOW,     _______, EMACS_BUFFER_REVERT,     _______, EMACS_COPY_FILE_PATH, LCTL(KC_7),     _______, EMACS_OTHER_WINDOW, _______, TMUX_SPLIT_WINDOW,
                                  TO(_BASE), _______, _______, _______, RALT(KC_ENTER), _______, RALT(RSFT(KC_H)),RALT(RSFT(KC_J)),RALT(RSFT(KC_K)),RALT(RSFT(KC_L)),RCTL(KC_SCOLON),RCTL(KC_QUOTE),
                                  _______, _______, _______, EMACS_WINDOW_CLOSE,    _______, _______, RALT(RSFT(KC_N)), EMACS_ACE_WINDOW_SWAP,    _______, _______, RALT(KC_SLASH),    _______,
_______, _______, _______, _______, OSL(18), _______, KC_NO,          RALT(KC_ENTER), _______, _______, _______, _______
  ...
  [_LAYER13] = LAYOUT_planck_grid(
    TD(DANCE_61),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_NO,          _______, _______, _______, _______, _______
  ),
