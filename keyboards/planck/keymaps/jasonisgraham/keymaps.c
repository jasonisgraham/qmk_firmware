const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    MT(MOD_LCTL, KC_LBRACKET), SYSTEM_LAYER_ACTIVATE,          KC_RGUI, KC_LALT, RAISE,          my_space, KC_NO,          LOWER,          right_of_lower,      LAYER_RAISE_HOLD,          LAYER_LOWER_HOLD, CYCLE_FAVE_ANIMATIONS
  ),
  ...
  [_SYSTEM] = LAYOUT_planck_grid(
    ...
    CYCLE_FAVE_ANIMATIONS, KC_NO, _______, _______, _______, _______, KC_NO,          KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE
  ),
  ...
  [_SHIFTLOCK] = LAYOUT_planck_grid(
    ...
    ESC_THEN_BASE_LAYER,          RSFT(KC_A),     RSFT(KC_S),     RSFT(KC_D),     RSFT(KC_F),     RSFT(KC_G),     RSFT(KC_H),     my_cap_j,     my_cap_k,     my_cap_l,     TD(DANCE_55),   TD(DANCE_56),
