...
[_RAISE] = LAYOUT_planck_grid(
                              ...
                              _______, _______, _______,_______,   _______,          _______, KC_INSERT,     my_raise_n,           my_raise_m,           my_raise_comma,         KC_3,           KC_BSLASH,
...
[_EDITING] = LAYOUT_planck_grid(
                                ...
                                _______, _______, EMACS_LOCCUR, _______, RALT(KC_ENTER), LCTL(KC_G), EMACS_SCROLL_UP, RALT(RSFT(KC_H)), editing_j, editing_k, RALT(RSFT(KC_L)), EMACS_COMMENT_READER,
