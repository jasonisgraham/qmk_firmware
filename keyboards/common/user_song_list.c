...
#define USER_SONG_LIST_INCLUDED 1
...
float __as6[][2] = SONG(__AS6);
float __b6[][2] = SONG(__B6);
float __c6[][2] = SONG(__C6);
float __cs6[][2] = SONG(__CS6);
float __d6[][2] = SONG(__D6);
float __ds6[][2] = SONG(__DS6);
float __e6[][2] = SONG(__E6);
float __f6[][2] = SONG(__F6);
float __fs6[][2] = SONG(__FS6);
