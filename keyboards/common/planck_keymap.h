#define planck_base  top_left,    my_q,    my_w,    my_e,    my_r,   my_t, mod_r1,    my_y,           my_u,    my_i,    my_o,     my_p, \
    ...
    hyper,  apl_level3_and_adhoc_hotkey, all_mods,       alt, RAISE,  super, mod_r4,   my_space,           LOWER,          emacs_and_backspace,   KC_LEFT,  KC_RIGHT
...
#define planck_code                                          _______, CLJ_FREQS, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______,   _______, EMACS_SPLIT_WINDOW_LEFT, EMACS_SPLIT_WINDOW_DOWN, EMACS_SPLIT_WINDOW_UP, EMACS_SPLIT_WINDOW_RIGHT, _______, \
...
#define planck_macros                                CLJ_ADD_REQS,   CLJ_FREQS, MAKE_COLORWAYS, _______, macros_r, COPY_TEXT_OPEN_NEW_TAB_SEARCH, _______, EMACS_COPY_FILE_PATH, EMACS_BACKWARD_UP, EMACS_YAS_FILTER_ANON, CD_C9, EMACS_INSERT_GI_GET_FEED, \
    TO_BASE, emacs_a, SSH_CRONJOBS_PROD, EMACS_YAS_DOC,     _______,     macros_g, EMACS_GOTO_PARSE_ITEM,  _______, _______, EMACS_YAS_KEYS_DESCRUCTURE, EMACS_YAS_TL,     EMACS_PF_UP, \
    _______, MAKE_COLORWAYS, CLJ_REFIND, EMACS_YAS_C,     _______, _______,  _______, EMACS_SYNC_FEED, emacs_m,     _______, CLJ_TAP, SHRUG, \
    _______, _______, _______, _______, _______, _______,EMACS_GOTO_ROLLUP ,          EMACS_GOTO_REMOTEID, _______, DM_REC1, DM_RSTP, DM_PLY1
