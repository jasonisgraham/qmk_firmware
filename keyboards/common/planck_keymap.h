...
#define planck_raise LSFT(KC_TAB),    my_raise_q,          my_raise_w,  KC_END,         EMACS_BUFFER_REVERT,       _______, _______, my_raise_y, my_raise_u,           my_raise_i,           my_raise_o,           my_raise_p, \
    ...
    MO(_SYSTEM), _______, _______,        _______,        TO(_BASE), _______,  KC_UP,      my_space,   raise_key_4_9,       raise_backspace,  _______,         TO(_BASE)
...
#define planck_shiftlock SHIFTLOCK_LAYER_DEACTIVATE,   LSFT(KC_Q),     LSFT(KC_W),     LSFT(KC_E),     LSFT(KC_R),     LSFT(KC_T), _______,    LSFT(KC_Y),     my_cap_u,     my_cap_i,     my_cap_o,     my_cap_p, \
    ...
    _______, _______, _______, _______, KC_UNDS, _______, _______,       _______,    LOWER,  _______, _______, _______
...
#define planck_system                                SYSTEM_LAYER_DEACTIVATE, _______, RGB_VAI, _______, _______,     _______, CYCLE_ACTIVE_APL_LEVEL3_FN, QK_KEY_OVERRIDE_ON, QK_KEY_OVERRIDE_OFF, QK_DEBUG_TOGGLE, QK_CLEAR_EEPROM, QK_BOOTLOADER, \
...
#define planck_macros                                TO_BASE,   _______, _______, _______, emacs_r, COPY_TEXT_OPEN_NEW_TAB_SEARCH, EMACS_GOTO_GET_FEED, EMACS_COPY_FILE_PATH, EMACS_BACKWARD_UP, EMACS_INSERT_GI_GET_FEED, _______, COPY_LATEST_FILE_TO_CLIPBOARD, \
    ...
    _______, _______, _______, EMACS_YAS_C,     _______, _______, EMACS_SYNC_FEED, _______, emacs_m,     _______, _______, TERM_CD_UP_DIR, \
