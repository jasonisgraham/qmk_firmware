...
void win_adhoc_y_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[30].step) {
        case SINGLE_TAP: register_code16(LGUI(KC_Y)); break;
        case DOUBLE_TAP: register_code16(LGUI(KC_Y)); register_code16(LGUI(KC_Y)); break;
        case DOUBLE_HOLD: register_code16(LALT(LCTL(LGUI(KC_Y)))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(KC_Y)); register_code16(LGUI(KC_Y));
    }
}
...
void win_adhoc_y_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[30].step) {
        case SINGLE_TAP: unregister_code16(LGUI(KC_Y)); break;
        case DOUBLE_TAP: unregister_code16(LGUI(KC_Y)); break;
        case DOUBLE_HOLD: unregister_code16(LALT(LCTL(LGUI(KC_Y)))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(KC_Y)); break;
    }
...
void win_adhoc_j_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[31].step) {
        ...
        case DOUBLE_TAP: register_code16(LGUI(KC_J)); register_code16(LGUI(KC_J)); break;
        case DOUBLE_HOLD: register_code16(LCTL(LALT(LGUI(KC_J)))); break;
...
void win_adhoc_j_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[31].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LGUI(KC_J)); break;
        case DOUBLE_HOLD: unregister_code16(LCTL(LALT(LGUI(KC_J)))); break;
...
void t_down_mon_th_minimiZe_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[35].step) {
        case SINGLE_TAP: register_code16(LGUI(RSFT(KC_UP))); break;
        case DOUBLE_TAP: register_code16(LGUI(RSFT(KC_UP))); register_code16(LGUI(RSFT(KC_UP))); break;
        case DOUBLE_HOLD: register_code16(LGUI(RSFT(KC_K))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(RSFT(KC_UP))); register_code16(LGUI(RSFT(KC_UP)));
    }
}
...
void t_down_mon_th_minimiZe_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[35].step) {
        case SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_UP))); break;
        case DOUBLE_TAP: unregister_code16(LGUI(RSFT(KC_UP))); break;
        case DOUBLE_HOLD: unregister_code16(LGUI(RSFT(KC_K))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_UP))); break;
    }
...
void t_left_mon_th_tile_left_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[36].step) {
        case SINGLE_TAP: register_code16(LGUI(RSFT(KC_LEFT))); break;
        case DOUBLE_TAP: register_code16(LGUI(RSFT(KC_LEFT))); register_code16(LGUI(RSFT(KC_LEFT))); break;
        case DOUBLE_HOLD: register_code16(LGUI(RSFT(KC_H))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(RSFT(KC_LEFT))); register_code16(LGUI(RSFT(KC_LEFT)));
    }
}
...
void t_left_mon_th_tile_left_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[36].step) {
        case SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_LEFT))); break;
        case DOUBLE_TAP: unregister_code16(LGUI(RSFT(KC_LEFT))); break;
        case DOUBLE_HOLD: unregister_code16(LGUI(RSFT(KC_H))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_LEFT))); break;
    }
...
void t_down_mon_th_minimize_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[37].step) {
        case SINGLE_TAP: register_code16(LGUI(RSFT(KC_DOWN))); break;
        case DOUBLE_TAP: register_code16(LGUI(RSFT(KC_DOWN))); register_code16(LGUI(RSFT(KC_DOWN))); break;
        case DOUBLE_HOLD: register_code16(LGUI(RSFT(KC_J))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(RSFT(KC_DOWN))); register_code16(LGUI(RSFT(KC_DOWN)));
    }
}
...
void t_down_mon_th_minimize_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[37].step) {
        case SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_DOWN))); break;
        case DOUBLE_TAP: unregister_code16(LGUI(RSFT(KC_DOWN))); break;
        case DOUBLE_HOLD: unregister_code16(LGUI(RSFT(KC_J))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_DOWN))); break;
    }
...
void t_right_mon_th_tile_right_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[38].step) {
        case SINGLE_TAP: register_code16(LGUI(RSFT(KC_RIGHT))); break;
        case DOUBLE_TAP: register_code16(LGUI(RSFT(KC_RIGHT))); register_code16(LGUI(RSFT(KC_RIGHT))); break;
        case DOUBLE_HOLD: register_code16(LGUI(RSFT(KC_L))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(RSFT(KC_RIGHT))); register_code16(LGUI(RSFT(KC_RIGHT)));
    }
}
...
void t_right_mon_th_tile_right_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[38].step) {
        case SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_RIGHT))); break;
        case DOUBLE_TAP: unregister_code16(LGUI(RSFT(KC_RIGHT))); break;
        case DOUBLE_HOLD: unregister_code16(LGUI(RSFT(KC_L))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(RSFT(KC_RIGHT))); break;
    }
