...
case TAP_INTERRUPTED_HELD:
  ...
  case HOLD:
    register_code16(LSFT(KC_K)); break;
  case HOLD2:
    register_code16(KC_UP);
    break;
...
case TAP_INTERRUPTED_HELD:
  ...
  case HOLD:
    unregister_code16(LSFT(KC_K)); break;
  /* case HOLD2: */
