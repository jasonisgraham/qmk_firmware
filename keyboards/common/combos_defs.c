...
const uint16_t PROGMEM combo_left_shift_forward_slash[] = {left_of_z, my_forward_slash, COMBO_END};
const uint16_t PROGMEM combo_raise_left_shift[] = {left_of_z, RAISE, COMBO_END};
...
const uint16_t PROGMEM combo_shift_alt[] = {LOWER, left_of_z, KC_LALT, COMBO_END};
