...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_moonlander(
                              ...
                              _______,_______,_______,_______,_______,   TD(DANCE_ROFI), EVIL_JUMP, _______,_______,_______,_______,_______,
                              TD(DANCE_LEFT_OR_HOME), KC_DOWN, my_lower_semi, KC_BSLASH, KC_UP, TD(DANCE_RIGHT_OR_END)
                              ),
  ...
  [_RAISE] = LAYOUT_moonlander(LSFT(KC_TAB),    my_raise_q,          my_raise_w,  KC_END,         EMACS_BUFFER_REVERT,       QK_CAPS_WORD_TOGGLE, _______,  _______, _______, my_raise_y, my_raise_u,           my_raise_i,           my_raise_o,           my_raise_p,
                               ...
                               TD(DANCE_RIGHT_OR_END), KC_UP,_______,_______, KC_DOWN,  TD(DANCE_LEFT_OR_HOME)
),
...
[_EDITING] = LAYOUT_moonlander(
                               ...
                               editing_left_shift, EMACS_RECENTER_ON_DEFUN, _______, EMACS_WINDOW_CLOSE,    TD(DANCE_SAVE_LOAD_NS_SWITCH), _______, _______,_______,_______,   next_win_or_frame, EMACS_ACE_WINDOW_SWAP,  editing_comma, editing_period, TERM_CD_UP_DIR,
...
[_ADHOC_SET_HOTKEY] = LAYOUT_moonlander(
                                        ...
                                        _______,_______,_______,_______,_______,   _______,_______, SET_HOTKEY_0, _______,_______, SET_HOTKEY_4,_______,
                                        _______,_______,_______,_______,  _______,  _______
                              ),
