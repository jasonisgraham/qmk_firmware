...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_moonlander(
                              top_left,    my_q,    my_w,    my_e,    my_r,   my_t, _______, _______, key_1_7,   my_y,           my_u,    my_i,    my_o,     my_p,
  ...
  [_RAISE] = LAYOUT_moonlander(
                               LSFT(KC_TAB),    my_raise_q,          my_raise_w,  KC_END,         EMACS_BUFFER_REVERT,       QK_CAPS_WORD_TOGGLE, _______,  _______, _______, my_raise_y, my_raise_u,           my_raise_i,           my_raise_o,           my_raise_p,
                               ...
                               MO(_SYSTEM), _______, KC_ENTER,        _______,        TO(_BASE),  _______, _______,      my_space , raise_key_4_9,       raise_backspace,     _______,      TO(_BASE),
                               _______,_______, _______,_______,_______,   CAPS_WORD,_______, RGB_MOD, _______,_______,_______,_______,
                               OSL(_HYPER),  _______,_______,_______, _______,  _______
),
...
[_LOWER] = LAYOUT_moonlander(
                             ...
                             LALT(KC_C),   KC_F1,          KC_F2,          KC_F3,          KC_F4,  TD(DANCE_73), _______,_______,_______,   KC_HOME,     my_lower_u,    my_lower_i,      my_lower_o,         my_lower_p,
                             ...
                             _______,   KC_F9,         KC_F10,         KC_F11,         KC_F12,         KC_APPLICATION, _______,_______, _______,   my_lower_n, my_lower_m, my_lower_comma,   my_lower_period, my_lower_slash,
...
[_ROFI] = LAYOUT_moonlander(
                            ...
                            ESC_THEN_BASE_LAYER, _______, _______, _______, _______, _______,   _______,_______, _______, _______, _______, ROFI_EMOJI, _______, _______,
...
[_EMACS] = LAYOUT_moonlander(
                             _______, EMACS_DESC_KEY, _______, _______, EMACS_HELM_MARK_RINGS, _______, _______,_______, _______, EMACS_YANK_IN_SEXP  , EMACS_BACKWARD_UP, _______, _______, _______,
                             _______, _______, _______, _______, EMACS_FINDER_COMMENTARY, _______, _______,_______, _______,  EMACS_SPLIT_WINDOW_LEFT, EMACS_SPLIT_WINDOW_DOWN, EMACS_SPLIT_WINDOW_UP, EMACS_SPLIT_WINDOW_RIGHT,_______,
...
[_EDITING] = LAYOUT_moonlander(
                               EMACS_ACE_WINDOW_SELECT, EMACS_DESC_KEY, LCTL(KC_7),     LCTL(KC_E), _______,     EMACS_TRANSPOSE, _______,_______, _______,  EMACS_YANK_IN_SEXP  , EMACS_NEXT_SEXP ,EMACS_PREV_SEXP ,  EMACS_HELM_OCCUR, KC_DELETE,

                               _______, _______, EMACS_LOCCUR, EMACS_KILL_IN_SEXP, LALT(KC_ENTER), EMACS_COPY_FILE_PATH, _______,_______, _______,   LALT(LSFT(KC_H)), editing_j, editing_k, editing_l, EMACS_PRIVATE_READER,
                               _______, EMACS_RECENTER_ON_DEFUN, _______, EMACS_WINDOW_CLOSE,    TD(DANCE_SAVE_LOAD_NS_SWITCH), _______, _______,_______,_______,   next_win_or_frame, EMACS_ACE_WINDOW_SWAP,  editing_comma, editing_period, TERM_CD_UP_DIR,
...
[_SYSTEM] = LAYOUT_moonlander(
                              ...
                              QK_CLEAR_EEPROM, _______ , _______, _______, _______, _______,  _______,_______, _______,    KC_AUDIO_MUTE, CYCLE_DROP_ANIMATIONS, _______, _______, RGB_TOG,
...
[_WINDOWS] = LAYOUT_moonlander(
                               ...
                               LALT(LGUI(KC_ESCAPE)), LGUI(KC_A),  select_slack, show_desktop     ,LGUI(KC_F),      _______, _______,_______, _______,  LGUI(KC_H),     TD(DANCE_43),   windows_k,   windows_l,   LGUI(KC_SCLN),
