...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_moonlander(
    ...
    my_left_shift,        my_z,           my_x,           my_c,           my_v,           my_b,                                           my_n,           my_m,   my_comma,   my_period,   my_forward_slash,   my_right_shift,
                              ...
                              super,  OSL(_EDITING), RGB_MODE_FORWARD,                       CYCLE_FAVE_ANIMATIONS, _______, my_space
  ),
  // lower
  ...
  [_EDITING] = LAYOUT_moonlander(
    ...
    _______, _______, _______,                 _______, _______, _______
                               ...
                               _______, _______, _______, _______, _______, _______, _______,                                 _______, _______, LALT(KC_7), LALT(KC_8), LALT(KC_9), _______, _______,
                               ...
                               _______, _______, _______, _______, _______, _______,                                 _______, TO(_BASE), RALT(RGUI(KC_SPC)), _______, _______, _______,
                             _______, _______, _______, _______, _______, _______,                                                                                                 _______, _______, _______, _______, _______, _______,
                             _______, _______, _______,                 _______, _______, _______
                               ),
