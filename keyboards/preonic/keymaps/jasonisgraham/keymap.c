...
#define my_h KC_H
#define my_i KC_I // TD(DANCE_7)
#define my_j KC_J //TD(DANCE_16)
#define my_k KC_K//TD(DANCE_17)
#define my_l KC_L //TD(DANCE_18)
...
#define my_m  KC_M //TD(DANCE_22)
#define my_minus TD(DANCE_10)
#define my_n TD(DANCE_21)
#define my_o KC_O //TD(DANCE_8)
#define my_p TD(DANCE_9)
#define my_period KC_DOT //TD(DANCE_24)
...
#define my_u KC_U // TD(DANCE_6)
#define my_v TD(DANCE_74)
#define my_w TD(DANCE_2)
#define my_x KC_X
#define my_y KC_Y
#define my_z TD(Z_OR_SHIFT) //KC_Z
