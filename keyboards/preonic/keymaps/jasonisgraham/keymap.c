...
[_BASE] = LAYOUT_preonic_grid(
                              OSL(_WINDOWS), KC_1 , KC_2 ,KC_3 ,KC_4 ,KC_5 , KC_6 ,KC_7 ,KC_8 ,KC_9 ,KC_0,  KC_DEL,
                              my_grave,    my_q,    my_w,    my_e,    my_r,    my_t,    my_y,           my_u,    my_i,    my_o,     my_p, KC_BSPACE,
                              my_lctl , my_a,   my_s,   my_d,   my_f,   my_g,  my_h,         my_j,   my_k,   my_l,   my_semicolon, KC_QUOT,
                              my_left_shift,        my_z,           my_x,           my_c,           my_v,           my_b,     my_n,   my_m,   my_comma,   my_period,   my_forward_slash, KC_MINUS,
                              hyper, KC_LEFT, KC_RIGHT, alt, RAISE,  super, my_space,           LOWER,          OSL(_EDITING),   key_4_11,  key_4_12, KC_ENTER
                              ),


[_LOWER] = LAYOUT_preonic_grid(
                               _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                               _______,   KC_F1,          KC_F2,          KC_F3,          KC_F4,          TD(DANCE_73),     KC_HOME,     my_lower_u,    my_lower_i,      my_lower_o,         my_lower_p, _______,
                               ...
                               _______, _______, _______ , _______, LM(_BOTH, MOD_LCTL | MOD_LALT | MOD_RCTL | MOD_LSFT),            _______,         _______, lower_LOWER,          lower_right_of_lower, lower_key_4_11, lower_key_4_12, _______
...
[_RAISE] = LAYOUT_preonic_grid(
                               ...
                               _______,   _______,          EMACS_OTHER_WINDOW,     KC_END,         EMACS_BUFFER_REVERT,      _______,          my_raise_y, my_raise_u,           my_raise_i,           my_raise_o,           my_raise_p, KC_DEL,
                               _______, _______, SHIFTLOCK_LAYER_ACTIVATE,  OSL(_WINDOWS),          RALT(KC_ENTER),       _______,     my_raise_h,         my_raise_j,           my_raise_k,           my_raise_l,           raise_semi,OSL(7),
                               _______, _______, _______,_______,   _______,          FISH_ACCEPT_SEND,     my_raise_n,           my_raise_m,           my_raise_comma,         KC_3,           KC_QUES,_______,
                               _______, _______, _______,        _______,        _______, _______,        KC_BSPACE,   raise_key_4_9,       KC_0,  _______,         TO(_BASE), MO(_ROFI)
...
[_BOTH] = LAYOUT_preonic_grid(
                              _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                             _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, TO(_GAUTH),
                             _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______,
                             _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_SYSTEM] = LAYOUT_preonic_grid(
                                _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                                SYSTEM_LAYER_DEACTIVATE, _______, _______, _______, _______,     _______, KC_PSTE, KC_AGIN, DEBUG, RESET_ANIMATION, RESET,_______,
...
[_WINDOWS] = LAYOUT_preonic_grid(
                                 ...
                                 _______, _______, _______,         LALT(KC_6),        _______,     _______,  LALT(KC_8),      _______,  ALT_TAB, _______, _______,  ALT_TAB
                                ),
...
[_EDITING] = LAYOUT_preonic_grid(
                                 _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                                 _______, _______, EMACS_OTHER_WINDOW,     LCTL(KC_E), EMACS_BUFFER_REVERT,     _______, EMACS_COPY_FILE_PATH, my_lower_u,     my_lower_i, EMACS_OTHER_WINDOW, EMACS_PROJECTILE_FIND_FILE, _______,
                                 _______, _______, _______, _______, RALT(KC_ENTER), _______, RALT(RSFT(KC_H)),RALT(RSFT(KC_J)),RALT(RSFT(KC_K)),RALT(RSFT(KC_L)), LCTL(KC_L),RCTL(KC_QUOTE),
                                 _______, _______, _______, EMACS_WINDOW_CLOSE,    KC_F12, _______,  RALT(RSFT(KC_N)), EMACS_ACE_WINDOW_SWAP,  LCTL(RALT(KC_H)), LCTL(RALT(KC_L)), TERM_CD_UP_DIR, _______,
                                 _______, _______, _______, _______, KC_HYPR,  _______,  KC_NO,          RALT(KC_ENTER), _______, _______, _______,_______
...
[_ROFI] = LAYOUT_preonic_grid(
                              _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                               ...
                               _______, _______, _______,    _______, _______, _______, RGUI(KC_SPC),    _______, _______, _______,_______, TO(_BASE)
                             ),
...
[_MOUSE] = LAYOUT_preonic_grid(
                               ...
                               _______, _______, _______, _______, MO(_EXTENDED), _______,  _______, TO(_BASE),          _______, _______, _______, _______
...
[_LAYER18] = LAYOUT_preonic_grid(
                                 _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                                 _______, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT, EMACS_SEL_7,    EMACS_SEL_8,           EMACS_SEL_9,           EMACS_SEL_0, KC_TRANSPARENT,
