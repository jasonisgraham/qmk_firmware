...
[_BASE] = LAYOUT_preonic_grid(
                             ...
                             top_left,    my_q,    my_w,    my_e,    my_r,   my_t, WEB_SAVE_FILE_UNDER_CURSOR,    my_y,           my_u,    my_i,    my_o,     my_p,
                             my_lctl , my_a,   my_s,   my_d,   my_f,   my_g, backspace,  my_h,         my_j,   my_k,   my_l,   my_semicolon,
                             my_left_shift,        my_z,           my_x,           my_c,           my_v,           my_b, KC_DELETE,     my_n,   my_m,   my_comma,   my_period,   my_forward_slash,
                             hyper, super_meta_hyper , KC_NO,  alt, RAISE,  super, esc_ctrl,   my_space,           LOWER,          my_right_of_lower,   key_4_11,  key_4_12
                              ),
...
[_EDITING] = LAYOUT_preonic_grid(
                                _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                                _______, OSL(_EMACS), LCTL(KC_7),     LCTL(KC_E), EMACS_HELM_MARK_RINGS,     EMACS_TRANSPOSE,        _______, EMACS_YANK_IN_SEXP  , scroll_next,     scroll_prev, EMACS_HELM_OCCUR, KC_DELETE,
...
[_EMACS] = LAYOUT_preonic_grid(
                              ...
                              _______, _______, _______, _______, EMACS_FINDER_COMMENTARY, _______,   _______, _______, _______, EMACS_DESC_KEY, _______, _______,
                              _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                              _______, _______, _______, _______,    _______, _______, _______, _______,    _______, _______, _______, _______
