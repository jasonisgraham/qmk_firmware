const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  OSL(_WINDOWS), _______, _______, KC_GRAVE, TD(DANCE_EXLM), TD(DANCE_AT), TD(DANCE_LPRN), TD(DANCE_RPRN), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
  my_q,    my_w,    my_e,    my_r,    my_t,   TD(DANCE_HASH),TD(DANCE_ASTR), my_y,           my_u,    my_i,    my_o,     my_p,
  my_a,   my_s,   my_d,   my_f,   my_g, TD(DANCE_DLR), TD(DANCE_AMPR), my_h,           my_j,   my_k,   my_l,   my_semicolon,
  my_z,           my_x,           my_c,           my_v,           my_b, TD(DANCE_PERC),  TD(DANCE_CIRC),      my_n,   my_m,   my_comma,   my_period,   my_forward_slash,
  hyper,  LGUI(LCTL(KC_LALT)), KC_LALT, RAISE,  super,  esc_ctrl, my_left_shift, my_space,           LOWER,           right_of_lower,   key_4_11,  key_4_12
  ),


  [_LOWER] = LAYOUT_preonic_grid(
                                 TD(DANCE_26), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
  ...
  [_RAISE] = LAYOUT_preonic_grid(
                                 TD(DANCE_32), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
  ...
  [_MOUSE] = LAYOUT_preonic_grid(
                                 TD(DANCE_34), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
...
[_SYSTEM] = LAYOUT_preonic_grid(
  ...
  [_WINDOWS] = LAYOUT_preonic_grid(
                                   ALT_TAB, TO(_BASE), _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
 ...
 TO(_BASE), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  ...
  [_GAUTH] = LAYOUT_preonic_grid(
                                 TO(_BASE), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
                                TO(_BASE), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, gauth_plex,
